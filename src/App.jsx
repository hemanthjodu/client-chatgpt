...
function App() {
  ...
  return (
    <div className="bg-[#1A232E] h-screen py-6 relative sm:px-16 px-12 
      ...
      <div className="uppercase font-bold text-2xl text-center mb-3">ChtaGPT2.0</div>

      <div className='h-[90%] overflow-auto w-full max-w-4xl px-4 py-8 min-w-20rem self-center
      scrollbar-thumb-slate-400 scrollbar-thin scrollbar-track-gray-transparent scrollbar-thumb-rounded-md'>
        <ChatBody chat={chat}/>
        </div>
      <div className='self-center w-full max-w-4xl min-w-[20rem]'>
